...
return {
 ...
 ["pt-br"] = "Abre o menu Expedição.",
	...
	-- Solo Play
	open_soloplay_view_key = {
		en = "Open Solo Play",
		ru = "Открыть соло-игру",
 ["zh-cn"] = "打开单人游戏",
 ["zh-tw"] = "開啟單人遊戲",
		de = "Solo-Spiel öffnen",
		fr = "Ouvrir Solo Play",
		ja = "ソロプレイを開く",
		ko = "솔로 플레이 열기",
		it = "Apri Solo Play",
		pl = "Otwórz Solo Play",
		es = "Abrir Solo Play",
 ["pt-br"] = "Abrir Solo Play",
	},
	open_soloplay_view_key_description = {
		en = "Opens the Solo Play configuration view.",
		ru = "Открывает меню настройки соло-игры.",
 ["zh-cn"] = "打开单人游戏配置界面。",
 ["zh-tw"] = "開啟單人遊戲配置介面。",
		de = "Öffnet die Solo-Spiel-Konfigurationsansicht.",
		fr = "Ouvre la vue de configuration Solo Play.",
		ja = "ソロプレイ設定ビューを開きます。",
		ko = "솔로 플레이 설정 화면을 엽니다.",
		it = "Apre la vista di configurazione di Solo Play.",
		pl = "Otwiera widok konfiguracji Solo Play.",
		es = "Abre la vista de configuración de Solo Play.",
 ["pt-br"] = "Abre a visualização de configuração do Solo Play.",
	},
}
